        ...
        if ("channel" in message) {
          switch (message.command) {
            ...
            case "STATUS":
              ...
              const playerState: MixerState.PlayerStateEnum =
                bapsicle_state.paused
                  ? "paused"
                  : bapsicle_state.playing
                  ? "playing"
                  : "stopped";
              store.dispatch(
                MixerState.setPlayerState({
                  player: channel,
                  state: playerState,
                })
              );
